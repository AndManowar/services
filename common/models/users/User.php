...
class User extends AppActiveRecord implements IdentityInterface
{
    ...
    /**
     * Роль - искатель услуги
     *
     * @const
     */
    const ROLE_SERVICE_SEEKER = 2;
    ...
    public static $roleList = [
        ...
        self::ROLE_SERVICE_SEEKER   => 'service seeker'
    ];
    ...
    {
        /** @var User $user */
        return self::findOneStrictException($condition);
    }
    ...
    /**
     * Список ролей для редактирования пользователя исходя из роли админа
     *
     * @param $role
     * @return array|mixed
     */
    public static function getRoleList($role)
    {
        switch ($role) {
            ...
            case self::ROLE_MANAGER:
                return [
                    self::ROLE_SERVICE_PROVIDER => 'Предоставитель услуг',
                    self::ROLE_SERVICE_SEEKER   => 'Искатель услуг'
                ];
                break;
        }
